  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="form-daftar-barang.php"><i class="fa fa-link"></i> <span>Tambah Barang</span></a></li>
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="proses-daftar-barang.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="harga" placeholder="Harga" class="form-control" id="inputHarga3" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="file" name="gambar" placeholder="Gambar" class="form-control" id="inputGambar3" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="stok" placeholder="Stok" class="form-control" id="inputStok3" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
