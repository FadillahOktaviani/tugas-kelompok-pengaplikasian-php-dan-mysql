...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="list-cari-admin.php" method="post" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Selamat datang Admin <?php echo $_SESSION['nama'];?> di website!
      </h1>
    </section>
                ...
                <tbody>
                  <?php
                    ...
                    while($data = mysqli_fetch_array($query)){
                      ...
                      echo "<td>"."<a href='form-edit-barang.php?id=".$data['kode_barang']."'>Edit</a>"."</td>";
                      echo "<td>"."<a href='proses-hapus-barang.php?id=".$data['kode_barang']."'>Hapus</a>"."</td>";
                ...
                <tbody>
                  <?php
                    ...
                    while($data = mysqli_fetch_array($query)){
                      ...
                      echo "<td>"."<a href='form-edit-admin.php?id=".$data['kode_user']."'>Edit</a>"."</td>";
                      echo "<td>"."<a href='proses-hapus.php?id=".$data['kode_user']."'>Hapus</a>"."</td>";
