        ...
        <div class="col-md-7">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Formulir Edit Anggota</h3>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="proses-edit-user.php">
              <div class="box-body">
                <input type="text" name="id" value="<?php echo $data['kode_user'] ?>" hidden>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="email" placeholder="Email" class="form-control" id="inputEmail3" value="<?php echo $data['email'] ?>" required></input>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="telp" placeholder="Telp" class="form-control" id="inputTelp3" value="<?php echo $data['telp'] ?>" required></input>
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <a href="list-data-user.php"><button type="button" class="btn btn-default">Batal</button></a>
